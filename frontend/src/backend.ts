...
export class Backend implements backendInterface {
    ...
    async createAlterationRequest(arg0: AlterationRequest): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createAlterationRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrUpdateCustomer(arg0: Customer): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrUpdateCustomer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAlterationRequestById(arg0: string): Promise<AlterationRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlterationRequestById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAlterationRequestsByCustomer(arg0: Principal): Promise<Array<AlterationRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAlterationRequestsByCustomer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAppointmentById(arg0: string): Promise<Appointment> {
        if (this.processError) {
            try {
    ...
    async getAppointmentsByCustomer(arg0: Principal): Promise<Array<Appointment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAppointmentsByCustomer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCustomerById(arg0: Principal): Promise<Customer> {
        if (this.processError) {
            try {
    ...
    async updateAlterationRequestStatus(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateAlterationRequestStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
